...
using System.Text;
#if MYRIA_LEADERBOARDR_USE_NEWTONSOFTJSON
...
{
    public class MyriaLeaderboardObfuscator
    {
        ...
        public static string ObfuscateJsonStringForLogging(string json)
        {
            ...
            return MyriaLeaderboardJson.SerializeObject(jsonObject);
            
#else //MYRIA_LEADERBOARDR_USE_NEWTONSOFTJSON
            ...
            return MyriaLeaderboardJson.SerializeObject(jsonObject);
#endif //MYRIA_LEADERBOARDR_USE_NEWTONSOFTJSON
        }
    }
}